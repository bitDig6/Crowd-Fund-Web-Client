...
const About = () => {
    return (
        <section className='w-11/12 mx-auto'>
            ...
            <div className='w-4/5 mx-auto flex gap-5 justify-center items-center p-10'>
                <div className='w-1/2 space-y-3 text-base font-semibold text-justify'>
                ...
                <Lottie className='bg-neutral w-1/3 mx-auto outline-2 outline-offset-8 border-2 border-pink-400 outline-pink-400' animationData={lottieAnimation}></Lottie>
            </div>
        </section>
    );
};
